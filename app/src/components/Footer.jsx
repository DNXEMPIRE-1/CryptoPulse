        ...
        <div className="md:flex-row lg:pb-10 justify-center items-center flex md:justify-around flex-col p-2 md:items-start md:1/4">
          <div className="flex flex-col justify-center items-center gap-2 md:justify-start md:items-start md:1/4">
            ...
            <p className="font-semibold font-sans text-center md:text-start w-full md:w-96 dark:text-cyan-400">
              ...
              news feeds for stocks and cryptocurrencies. <br /> Stay informed
          ...
          <div className="flex md:flex-col md:mt-0 mt-4  md:1/4 justify-start text-left items-center gap-6 md:items-start">
            <h2 className="text-3xl font-bold text-slate-800 dark:text-cyan-100 mb-4">
              Follow Us
            </h2>
              ...
              <div className="mb-2">
                <Link to="https://www.instagram.com/CryptoPulse/" target="_blank">
                  <AiFillInstagram
                    title="Instagram"
                    size={30}
                    className="fill-gray-700 hover:fill-red-600 hover:transform hover:scale-125 transition-all duration-200 ease-in-out"
                  />
                </Link>
              </div>
              <div className="mb-2">
                <Link to="https://twitter.com/CryptoPulseco" target="_blank">
                  <BsTwitter
                    title="Twitter"
                    size={30}
                    className="fill-gray-700 hover:fill-[#00acee] hover:transform hover:scale-125 transition-all duration-200 ease-in-out"
                  />
                </Link>
              </div>
              <div className="mb-2">
                ...
                >
                  <BsLinkedin
                    size={30}
                    title="Linkedin"
                    className="fill-gray-700 hover:fill-[#0A66C2] hover:transform hover:scale-125 transition-all duration-200 ease-in-out"
                  />
                </Link>
              </div>
                ...
                >
                  {hover ? (
                    <img
                      ...
                      title="Koo"
                      alt="koo-icon"
                      className=" hover:transform hover:scale-125 transition-all duration-200 ease-in-out"
              ...
              <div className="mb-2">
                ...
                >
                  <BsGithub
                    title="Github"
                    size={30}
                    className="fill-gray-700 hover:fill-[black] dark:hover:fill-white hover:transform hover:scale-125 transition-all duration-200 ease-in-out"
                  />
                </Link>
              </div>
            </div>
          ...
          <div className="md:w-1/4 w-full px-3 mb-3 md:mb-0 text-left">
            <h2 className="text-3xl font-bold text-slate-800 mb-4 dark:text-cyan-100">
              Newsletter
            </h2>
            <form onSubmit={handleSubmit}>
              <div className="flex flex-col pb-4">
                <AiFillMail
                  className="relative top-[30px] ml-2 text-gray-700"
                  size={20}
                />
                <input
                  type="email"
